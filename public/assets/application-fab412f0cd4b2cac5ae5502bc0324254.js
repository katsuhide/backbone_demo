...
(function() {
  ...
  $(document).ready(function() {
    return BackboneDemo.initialize();
  });

}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["todos/item"] = function(__obj) {
    if (!__obj) __obj = {};
    ...
    (function() {
      (function() {
        ...
        __out.push(__sanitize(this.item.get('done') ? 'checked="checked"' : ''));
      
        __out.push(' />\n  <label>');
      
        __out.push(__sanitize(this.item.get('content')));
...
(function() { this.JST || (this.JST = {}); this.JST["todos/stats"] = function(__obj) {
    if (!__obj) __obj = {};
    var __out = [], __capture = function(callback) {
      var out = __out, result;
      __out = [];
    ...
    (function() {
      (function() {
        if (this.todos.done().length) {
          ...
          __out.push(__sanitize(this.todos.done().length));
          __out.push(' completed ');
          __out.push(__sanitize(this.todos.done().length === 1 ? 'item' : 'items'));
          __out.push('\n  </a>\n');
        }
        ...
        __out.push(__sanitize(this.todos.remaining().length === 1 ? 'item' : 'items'));
...
(function() {
  ...
  BackboneDemo.Models.Todo = (function(_super) {
...
(function() {
  ...
  BackboneDemo.Collections.Todos = (function(_super) {
    ...
    Todos.prototype.model = BackboneDemo.Models.Todo;
...
(function() {
  ...
  BackboneDemo.Views.TodosIndex = (function(_super) {
    ...
    TodosIndex.prototype.template = JST['todos/stats'];

    TodosIndex.prototype.el = '#todoapp';
    ...
    TodosIndex.prototype.initialize = function() {
    ...
    TodosIndex.prototype.addOne = function(todo) {
      var view;
      view = new BackboneDemo.Views.TodosItem({
        model: todo
      });
      return this.$('#todo-list').append(view.render().el);
    };

    TodosIndex.prototype.addAll = function() {
      return this.collection.each(this.addOne, this);
    };

    TodosIndex.prototype.createOnEnter = function(e) {
      var text;
      text = this.$('#new-todo').val();
    ...
    TodosIndex.prototype.clearCompleted = function() {
      _.invoke(this.collection.done(), 'destroy');
      return false;
    };

    TodosIndex.prototype.toggleAllComplete = function() {
      var done;
      done = this.$('#toggle-all').prop('checked');
...
(function() {
  ...
  BackboneDemo.Views.TodosItem = (function(_super) {
    __extends(TodosItem, _super);

    function TodosItem() {
      return TodosItem.__super__.constructor.apply(this, arguments);
    }

    TodosItem.prototype.template = JST['todos/item'];

    TodosItem.prototype.tagName = 'li';

    TodosItem.prototype.events = {
    ...
    TodosItem.prototype.initialize = function() {
      this.listenTo(this.model, 'change', this.render);
      return this.listenTo(this.model, 'destroy', this.remove);
    };

    TodosItem.prototype.render = function() {
    ...
    TodosItem.prototype.toggleDone = function() {
      return this.model.toggle();
    };

    TodosItem.prototype.edit = function() {
      this.$el.addClass('editing');
      return this.$('edit').focus();
    };

    TodosItem.prototype.close = function() {
      var value;
      value = this.$('edit').val();
      if (!value) {
        return this.clear();
    ...
    TodosItem.prototype.updateOnEnter = function(e) {
      if (e.keyCode === 13) {
        return this.close();
      }
    };

    TodosItem.prototype.clear = function() {
...
(function() {
  ...
  BackboneDemo.Routers.Todos = (function(_super) {
    __extends(Todos, _super);
    ...
    Todos.prototype.initialize = function() {
      this.collection = new BackboneDemo.Collections.Todos();
      return this.collection.fetch({
        reset: true
      });
    };

    Todos.prototype.index = function() {
      var view;
      return view = new BackboneDemo.Views.TodosIndex({
